...
class CombinedJeffersonPackageTests(unittest.TestCase):
    def test_manifest_declares_disjoint_catalog_and_historical_corpora(self):
        ...
        self.assertIn("4,928 source-backed Sowerby entries", manifest["copy"]["coverage_statement"])
        self.assertIn("4,931 historical source positions", manifest["copy"]["coverage_statement"])
